...
5. Click the physical **Save** (Floppy Disk) icon option.
6. Click the blue **Deploy** macro button option in the menu grid, then select **New deployment**.
7. Click the setup gear widget next to "Select type" and opt for **Web app**.
8. Fill out your final parameter configurations exactly as follows:
...
9. Hit **Deploy**, step through the basic Google authorization consent prompts, and **Copy the generated Web app URL string** to your clipboard.

---

## 🎯 Usage Manual
1. Navigate to any target creator profile webpage on [Instagram (Web version)](https://instagram.com).
